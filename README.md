...
if the customer has done more than 5 return categorize them as returning otherwise new. List customers id, name, total orders, total returns
...
Calculate the total revenue handled by each shipping provider. Include the total number of orders handled and the average delivery time for each provider.
...
18. Top 10 product with highest decreasing revenue ratio compare to last year(2022) and current_year(2023). Return product_id, product_name, category_name, 2022 revenue and 2023 revenue decrease ratio at end Round the result
